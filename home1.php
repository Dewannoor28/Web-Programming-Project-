...
<body>
    <div id="content">
        ...
        <div id="routine-buttons">
            ...
            <a href="createroutine.html" class="custom-button">
                <img src="d:\Projects\Website\edit-interface-symbol-of-a-pencil-on-a-square-outline-paper.png"
                    alt="Create Routine">
                Create Routine
            </a>
            <a href="Showroutine.html" class="custom-button" onclick="showRoutine()">
                <img src="d:\Projects\Website\10613736_10172.jpg" alt="Find Your Routine">
                All Routines
            </a>
            <a href="searchroutine.html" class="custom-button" onclick="searchRoutine()">
                <img src="d:\Projects\Website\magnifying-glass.png" alt="Search Routine">
                Search Routine
            </a>
            <a href="searchteacher.html" class="custom-button" onclick="searchTeacherSchedule()">
                <img src="d:\Projects\Website\288ppi\Asset 1.png" alt="Search Teacher Schedule">
